...
const MOCK_POSTS: Post[] = [
  {
    ...
    title: "Faxina completa apartamento",
    description: "Preciso de faxineira para limpeza completa de apartamento 2 quartos. Incluindo janelas, banheiros e cozinha. Produtos por minha conta.",
    category: "Faxina", city: "São Paulo, SP", budget_min: 150,
    created_at: new Date(Date.now() - 1800000).toISOString(),
    latitude: null, longitude: null,
    profiles: { id: "m1", full_name: "Ana Souza", avatar_url: null, city: "São Paulo, SP", score: null, seal: null, verified: false },
  },
  {
    id: "mock-2", user_id: "mock", isMock: true, mockInteresse: 7,
    title: "Instalação elétrica",
    description: "Preciso instalar 4 tomadas e trocar o quadro de luz. Casa de 3 cômodos. Urgente, pode ser essa semana.",
    category: "Elétrica", city: "Guarulhos, SP", budget_min: 280,
    created_at: new Date(Date.now() - 7200000).toISOString(),
    latitude: null, longitude: null,
    profiles: { id: "m2", full_name: "Carlos Lima", avatar_url: null, city: "Guarulhos, SP", score: null, seal: null, verified: false },
  },
  {
    id: "mock-3", user_id: "mock", isMock: true, mockInteresse: 2,
    title: "Pintura sala e quartos",
    description: "Pintura interna de sala + 2 quartos, aproximadamente 60m². Já tenho a tinta, preciso da mão de obra.",
    category: "Pintura", city: "Santo André, SP", budget_min: 600,
    created_at: new Date(Date.now() - 18000000).toISOString(),
    latitude: null, longitude: null,
    profiles: { id: "m3", full_name: "Mariana Costa", avatar_url: null, city: "Santo André, SP", score: null, seal: null, verified: false },
  },
  {
    id: "mock-4", user_id: "mock", isMock: true, mockInteresse: 5,
    title: "Aulas de inglês online",
    description: "Procuro professor de inglês para aulas online 3x por semana, nível básico/intermediário. Foco em conversação.",
    category: "Aulas", city: "Online", budget_min: 80,
    created_at: new Date(Date.now() - 86400000).toISOString(),
    latitude: null, longitude: null,
    profiles: { id: "m4", full_name: "Roberto Alves", avatar_url: null, city: "Online", score: null, seal: null, verified: false },
  },
  {
    id: "mock-5", user_id: "mock", isMock: true, mockInteresse: 9,
    title: "Reforma banheiro completo",
    description: "Reforma completa de banheiro: troca de revestimentos, vaso, pia e chuveiro. Aproximadamente 4m².",
    category: "Reformas", city: "São Bernardo, SP", budget_min: 2500,
    created_at: new Date(Date.now() - 172800000).toISOString(),
    latitude: null, longitude: null,
    profiles: { id: "m5", full_name: "Fernanda Gomes", avatar_url: null, city: "São Bernardo, SP", score: null, seal: null, verified: false },
  },
];
